...
export const mockCategories: ICategoryWithMenus[] = [
  ...
  createCategory(8, '옵션 없는 메뉴', noOptionMenus, {
    isHidden: false,
    isQuantitySelectable: true,
    isFirstOrderRequired: false,
    localeCategoryName: {
  ...
  createCategory(9, '옵션 없는 메뉴', noOptionMenus, {
    isHidden: false,
    isQuantitySelectable: true,
    isFirstOrderRequired: false,
    localeCategoryName: {
  ...
  createCategory(10, '옵션 없는 메뉴', noOptionMenus, {
    isHidden: false,
    isQuantitySelectable: true,
    isFirstOrderRequired: false,
    localeCategoryName: {
  ...
  createCategory(11, '옵션 없는 메뉴', noOptionMenus, {
    isHidden: false,
    isQuantitySelectable: true,
    isFirstOrderRequired: false,
    localeCategoryName: {
  ...
  createCategory(12, '옵션 없는 메뉴', noOptionMenus, {
    isHidden: false,
    isQuantitySelectable: true,
    isFirstOrderRequired: false,
    localeCategoryName: {
  ...
  createCategory(13, '옵션 없는 메뉴', noOptionMenus, {
    isHidden: false,
    isQuantitySelectable: true,
    isFirstOrderRequired: false,
    localeCategoryName: {
