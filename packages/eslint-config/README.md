...
이 패키지는 다음과 같은 성격을 가진 ESLint 설정을 제공합니다:

- **일관성**: 여러 프로젝트에서 동일한 린팅 규칙 적용
- **재사용성**: 프로젝트 타입별로 최적화된 설정 제공
- **유지보수성**: 중앙 집중식 설정 관리로 업데이트 용이
- **코드 품질**: TypeScript, React 등에 대한 엄격한 린팅 규칙 적용
